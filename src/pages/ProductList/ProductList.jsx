...
function ProductList({ setProgress }) {
  ...
  const { data, isFetching, isLoading } = useVersions(queryParamsConfig, { placeholderData: keepPreviousData })
  ...
  return (
    <div className='mx-auto mb-20 mt-5 max-w-[1400px] p-6'>
      ...
      <div className='flex justify-between'>
        <h2 className='hidden sm:block h-10 text-xl lg:text-2xl xl:text-3xl font-bold uppercase'>Danh sách sản phẩm</h2>
          ...
          <ol className='inline-flex items-center space-x-1 md:space-x-3'>
            ...
            <li className='cursor-pointer' aria-current='page opacity-60'>
              <div className='flex items-center'>
                ...
                <Link to={path.productList} className='ml-1 text-sm text-gray-500 md:ml-2'>
                  Danh sách sản phẩm
                </Link>
              </div>
            </li>
