...
function SidebarMenu() {
  ...
  return (
    <div
      className={
        isOpenSidebarMenu
          ? 'fixed top-[144px] left-0 w-64 text-white h-full bg-[#242525] z-50 shadow-lg transition-transform transform duration-300 ease-in-out overflow-y-auto no-scrollbar'
          : 'fixed top-[144px] left-0 w-64 text-white h-full bg-[#242525] z-50 shadow-lg transition-transform transform duration-300 ease-in-out -translate-x-full overflow-y-auto no-scrollbar'
      }
    >
